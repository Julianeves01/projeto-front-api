    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-50 font-Poppins">
      <div className="bg-pink-200/90 rounded-xl shadow-lg p-5 text-center max-w-xl w-full mb-5">
        ...
        <p className="text-gray-700 mb-4 text-base">
          ...
          Nesse site estou explorando o universo das APIs com um toque Animado. Este projeto utiliza uma API de Filmes de Animação — tudo com um visual divertido e funcional. Abaixo você pode explorar meus projetos, conhecer as linguagens que utilizo, e conferir meu perfil profissional clicando nos ícones abaixo 🚀.
        </p>
